    ...
    <div class="tab-pane med-text fade in active" id="tab_sec1">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center animated fadeInUp">
                <h1 class="">UN POCO DE HISTORIA</h1>
                <i class="icon-camera medium-icon white-text"></i>
            </div>
            <div class="col-md-12 col-sm-12 text-center gray-text">
                <p class="text-large"> <strong>La Farmacia Central</strong> se inauguró en el año 1990 en la calle Santa Fé 172 de Neuquén Capital.
                    <br>
                    En 12 de Agosto del año 2000 se trasladó al edificio ubicado en calle Roca 698.
                </p>
                <hr>
                <p class="text-large"> <strong>La Farmacia Oeste</strong> se inauguró el día 15 de Abril del año 2013, ubicada en calle Antártida Argentina 3415.
                </p>
