                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-justify  gray-text">
                            <p class="text-large"> En las Farmacias Sociales IMPS el empleado de la Municipalidad de Neuquén es afiliado directo,
                                ...
                                <br>
                                <br>
                                Además en ambas farmacias se atienden a afiliados de: <strong> SOSUNC - ISSN - AMEJUN - IOSE - DIBA</strong>
                            </p>
                            <p class="text-large">
                                El afiliado de la Municipalidad de Neuquén tiene la posibilidad de comprar en las farmacias IMPS  con  la modalidad <strong>“Descuento por planilla por órdenes de compra”</strong>.
                            </p>
                            <p class="text-large">
